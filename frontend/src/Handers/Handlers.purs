...
setupEventHandlers (Tuple (HtmlInputs { cutStart, cutEnd, youtubeUrl, setCutStartButton, setCutEndButton }) (HtmlOutputs { playbackPosition })) = do
  -- TODO: Add handlers for the cut start and cut end buttons to get the current positions and set the values of the sliders
  setVideoHandlers (VET { cutStart: cutStart, cutEnd: cutEnd, playbackPosition: playbackPosition, setCutStartButton: setCutStartButton, setCutEndButton }) ytUrlEventTarget
