...
reverseLoopGifId :: String
reverseLoopGifId = "reverseLoopGif"
...
loadingModalExtraConentId :: String
loadingModalExtraConentId = "loadingModalExtraContent"
