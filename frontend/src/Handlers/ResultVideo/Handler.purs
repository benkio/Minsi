...
import Components.HtmlComponents.Lenses (_playbackPositionResultVideo, _resultAudio, _resultVideo, _videoSource)
...
updatePlaybackPosition = do
  ...
  let
    playbackPositionResultVideo = view _playbackPositionResultVideo components
